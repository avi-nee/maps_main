...
class NewAppeal extends StatefulWidget {
  const NewAppeal({super.key});

  @override
  State<NewAppeal> createState() => _NewAppeal();
}

TextEditingController appealdateCtl = TextEditingController();
TextEditingController oiodateCtl = TextEditingController();

class _NewAppeal extends State<NewAppeal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Add New Appeal'),
      ),
      body: Form(
        key: _formKey,
        child: Padding(
